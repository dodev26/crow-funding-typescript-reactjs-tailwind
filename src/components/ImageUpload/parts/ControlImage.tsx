...
interface IControllImages extends Omit<React.InputHTMLAttributes<HTMLInputElement>, 'multiple' | 'ref'> {
  errorField?: string | undefined
  hideError?: boolean
  className?: string
  onChange: (e: React.ChangeEvent<HTMLInputElement>) => void
}
const ControllImage = forwardRef<HTMLInputElement, IControllImages>(
  ({ errorField, hideError = false, className, onChange, ...props }, ref) => {
    return (
