...
export const Select = ({ placeholder, className, selected, type = "primary" }: ISelect) => {
  ...
  return <div
    className={classNames("flex items-center justify-between  bg-white dark:bg-transparent border border-strock dark:border-darkStroke rounded-lg cursor-pointer text-sm text-text4", className, {
