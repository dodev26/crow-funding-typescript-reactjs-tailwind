...
export const DashboardSearch = () => {
  ...
  return (
    <div className='relative z-50'>
      <div
        ref={groupInputRef}
        className='bg-white dark:bg-darkSecondary dark:border-none border  dark:shadow-none border-strock flex items-center z-10 relative rounded-full shadow-[10px_10px_20px_0px_rgba(218,_213,_213,_0.15)]  p-2'
      >
        <div className='flex-1 pr-5'>
          <input
            ...
            className='pl-4 text-sm w-full dark:text-white bg-transparent placeholder:text-text4 text-text1'
          />
        </div>
      ...
      {showSearch && (
        <>
          ...
          <div
            ref={resultRef}
            className='search-results pb-6 pt-3 pl-6 pr-3 w-full lg:w-[843px] bg-white absolute top-full  left-0 z-10 translate-y-5  overflow-hidden rounded-3xl'
          >
            <div className='flex items-center justify-between  bg-graySoft'>
              ...
              <button
                ...
                className='w-[72px] flex items-center justify-center h-[50px] rounded-xl bg-error/20 text-error'
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  fill='none'
...
function SearchItem() {
  return (
    <div className='flex items-center gap-x-5'>
      <img
        src='https://images.unsplash.com/photo-1688748628506-4b1acfc6b82b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=465&q=80'
        alt=''
